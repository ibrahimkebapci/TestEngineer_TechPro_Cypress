...
SELECT UPPER(firstname) AS LENGTH(firstname),LOWER(lastname)
AS lname, LENGTH(lastname)
FROM teachers
...
INSERT INTO employees(id,sehir) VALUES(123,'Ankara')
